...
namespace Modules\Lecturers\Http\Controllers;

use Exception;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Illuminate\Routing\Controller;
use Modules\Lecturers\Http\Requests\StoreRequest;
use Modules\Lecturers\Http\Requests\UpdateRequest;
...
class LecturersController extends Controller
{
    ...
    /**
     * @param LecturersRepositoryInterface $repository
     * @return void
     * @author Mahmoud Ahmed <mahmoud.ahmed@gatetechs.com>
     */
    public function __construct(LecturersRepositoryInterface $repository)
    {
    ...
    public function store(StoreRequest $request): JsonResponse
    {
        try {
            ...
            if ($response === true) {
                $data = ['message' => trans('app.lecturers.created')];
    ...
    public function update(UpdateRequest $request, $id): JsonResponse
    {
        try {
            ...
            if ($response === true) {
                $data = ['message' => trans('app.lecturers.updated')];
                return response()->json(['data' => $data], 200);
            } else {
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            if ($response === true) {
                $data = ['message' => trans('app.lecturers.deleted')];
                return response()->json(['data' => $data], 200);
            } else {
